    ...
    <div className="flex items-center flex-col w-full justify-center md:w-full md:justify-start">
      ...
      {cartItems.map((item, index) => {
        return (
          <div
            key={item.itemName}
            className="flex border p-2 m-2 sm:w-full md:w-7/12"
          >
            <div className="flex items-center w-full md:w-9/12">
              ...
              />
              <div>
                <h2 className="p-2 m-2 text-2xl font-bold">{item.itemName}</h2>
      ...
      <OrderForm />
      <div className="sticky bottom-0 flex p-2 m-2 w-full md:w-7/12 justify-between">
